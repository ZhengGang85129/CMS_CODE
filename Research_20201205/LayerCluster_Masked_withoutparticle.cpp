...
const double font_offset= 1.1;

const float Left_Margin = 0.13;
const float Right_Margin = 0.13;
const float Bottom_Margin = 0.13;
const float Top_Margin = 0.13;
...
void LayerCluster_Masked_withoutparticle()
{
...
//    gPad->SetFixedAspectRatio();
    ...
    Double_t hist_q_width_L=-1.2;
    Double_t hist_q_width_R=-0.2;
    Double_t hist_q_height_D=+2.0;
    Double_t hist_q_height_T=+3.0;
  
    Double_t hist_g_width_L=-0.5;
    Double_t hist_g_width_R=+0.5;
    Double_t hist_g_height_D=-3.2;
    Double_t hist_g_height_T=-2.2;
    
    Double_t resolution = 50;
    Int_t Resolution_hist_q_w = ( hist_q_width_R- hist_q_width_L)*resolution; 
    Int_t Resolution_hist_q_h = ( hist_q_height_T- hist_q_height_D)*resolution; 
    Int_t Resolution_hist_g_w = ( hist_g_width_R- hist_g_width_L)*resolution; 
    Int_t Resolution_hist_g_h = ( hist_g_height_T- hist_g_height_D)*resolution; 
                           ...
                           for(Int_t k = 0 ; k < LayerCluster_track; k++ )
                           {
                               ...
                               for(int layer=0;layer<hgcallayer_max;layer++)
                               {
                                   ...
                                   { 
                                       ...
                                       {
                                           double dR_LC=TMath::Sqrt((LayerCluster_eta[k]-ak4pfjets_eta[min_pos])*(LayerCluster_eta[k]-ak4pfjets_eta[min_pos])\
                                                    +(LayerCluster_phi[k]-ak4pfjets_phi[min_pos])*(LayerCluster_phi[k]-ak4pfjets_phi[min_pos]));
                                           if(dR_LC < 0.8)   
