...
//    gPad->SetFixedAspectRatio();
    ...
    TH2D *Quark_HGCalhits = new TH2D("HGCal Hits for q"," Quark hits " , 100 , -4, 4 , 100 , -4 , 4 ) ;
    TH2D *Gluon_HGCalhits = new TH2D("HGCal Hits for g"," Gluon hits " , 100 , -4, 4 , 100 , -4 , 4 ) ;
    TH2D *Quark_PFJets = new TH2D("PFJets for q ", " pfjets for q " , 100 , -4 , 4 , 100 , -4 , 4 );
    TH2D *Gluon_PFJets = new TH2D("PFJets for g ", " pfjets for g " , 100 , -4 , 4 , 100 , -4 , 4 );
